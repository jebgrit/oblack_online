                            ...
                            <div class="card-body">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4> #{{ $ticket->ticket_id }} - {{ ucfirst($ticket->title) }} </h4>
                                    </div>
                                ...
                                @if ($ticket->status == 'Fermé')
                                    <input class="form-control mb-3" type="text" placeholder="Le ticket est fermé. Pour tout autre demande veillez ouvrir un nouveau ticket."
