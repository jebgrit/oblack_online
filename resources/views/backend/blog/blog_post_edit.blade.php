    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Modifier une publications</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form id="myForm" action="{{ route('update.blog.post') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="post_title"
                                            value="{{ old('post_title') ?? $blog_post->post_title }}" required />
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('post_long_description') is-invalid @enderror" id="mytextarea"
                                            name="post_long_description">
                                            {!! old('post_long_description') ?? $blog_post->post_long_description !!}
                                        </textarea>
                                        <span class="text-danger">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <img src="{{ asset($blog_post->post_image) }}" id="showImage" alt=""
                                            class="mt-4" style="width: 100px; height: 100px">
                                    </div>
                                </div>
                            </div>
                            <!-- Submit -->
