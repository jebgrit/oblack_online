            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Modifier un slider</li>
                    </ol>
                </nav>
            </div>
        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="file"
                                                ...
                                                name="slider_image" id="image" accept='.jpg,.jpeg,.png,.webp' />
                                            <span class="text-danger">
                                                @error('slider_image')
                                                    Merci de télécharger uniquement des images.
                                                @enderror
                                            </span>
                                        </div>
                                    </div>
