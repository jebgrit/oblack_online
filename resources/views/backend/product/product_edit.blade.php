...
@section('admin')
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row g-3 mb-4">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="product_name" class="form-control @error('product_name') is-invalid @enderror" id="product_name" value="{{ $products->product_name }}" >
                                ...
                                <div class="row g-3 mb-4">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="single-select select2-hidden-accessible" name="product_country">
                                            <option value="{{ $products->product_country }}" {{ $products->id == $products->product_country ? 'selected' : '<< choisissez >>' }}>
                                                {{ $products->product_country }}
                                            </option>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-select" name="product_size">
                                            <option value="{{ $products->product_size }}" {{ $products->id == $products->product_size ? 'selected' : '<< choisissez >>' }}>
                                ...
                                <div class="row g-3 mb-4">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="product_type" class="form-select">
                                            <option value="{{ $products->product_type }}" {{ $products->id == $products->product_type ? 'selected' : '<< choisissez >>' }}>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-select" name="product_color" >
                                            <option value="{{ $products->product_color }}" {{ $products->id == $products->product_color ? 'selected' : '<< choisissez >>' }}>
                                ...
                                <div class="row g-3 mb-4">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label>Prix</label>
                                        <input type="text" name="product_price" class="form-control @error('product_price') is-invalid @enderror" id="product_price" value="{{ $products->product_price }}">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="discount_price" class="form-control @error('discount_price') is-invalid @enderror" id="discount_price" value="{{ $products->discount_price }}">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="product_quantity" class="form-control @error('product_quantity') is-invalid @enderror" id="product_quantity" value="{{ $products->product_quantity }}" >
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-select @error('vendor_id') is-invalid @enderror" name="vendor_id" id="vendor_id" >
                                            ...
                                            @foreach ($activeVendor as $vendor)
                                                <option value="{{ $vendor->id }}" {{ $vendor->id == $products->vendor_id ? 'selected' : '' }}>
                                                    {{ $vendor->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <textarea class="form-control @error('long_description') is-invalid @enderror" id="mytextarea" name="long_description">{{ old('long_description') ?? $products->long_description }}</textarea>
    ...
    <div class="page-content">
        <h6 class="mb-0 text-uppercase">Modifier l'image de couverture</h6>
        <hr>
        <div class="card">
            <div class="card-body">
                <table class="table mb-0 table-hover">
                    <thead>
                        <tr>
                            <th scope="col">Image actuelles</th>
                            <th scope="col">Choisir nouvelles images</th>
                    ...
                    <tbody>
                        <form action="{{ route('update.product.thumbnail') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="old_img" value="{{ $products->product_thumbnail }}">
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ asset($products->product_thumbnail) }}" class="img-thumbnail" width="175" height="175" style="height:175px;">


                                    </td>
                                    <td>
                                        <input name="product_thumbnail" class="form-group @error('product_thumbnail') is-invalid @enderror" type="file" accept='.jpg,.jpeg,.png,.webp'>
                                    </td>
                                    <td>
                                        <div class="d-flex ">
                                            <input type="submit" class="btn btn-link" value="Enregistrer" />
                                        </div>
                                    </td>
                                </tr>
                        </form>
    ...
    <!--Images-->
    <div class="page-content">
        <h6 class="mb-0 text-uppercase">Modifier les images du produit</h6>
        <hr>
        <div class="card">
            <div class="card-body">
                <table class="table mb-0 table-hover">
                        ...
                        <form action="{{ route('update.product.multiimage') }}" method="POST" enctype="multipart/form-data">
                            ...
                            @foreach ($images as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset($item->photo_name) }}" class="img-thumbnail" width="175" height="175" style="height:175px;">
                                    </td>
                                    <td>
                                        <input type="file" class="form-group @error('multi_img') is-invalid @enderror" name="multi_img[{{ $item->id }}]" accept='.jpg,.jpeg,.png,.webp'>
                                    </td>
                                    <td>
                                        <div class="d-flex ">
                                            <input type="submit" class="btn btn-link" value="Enregistrer" />
                                            <span class="px-1"></span>
                                            <a href="{{ route('product.multiimage.delete', $item->id) }}" id="delete" class="btn btn-link">Supprimer</a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
