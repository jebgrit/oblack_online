            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Profile Administrateur</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    ...
                                    <div class="mt-3">
                                        <h4>{{ ucfirst($adminData->name) }}</h4>
                                        <p class="text-secondary mb-1">{{ ucfirst($adminData->username) }}</p>
                                    </div>
                                </div>
                                <hr class="my-4">
                                ...
                                <form action="#" method="POST" enctype="multipart/form-data" id="myForm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" id="username" name="username" class="form-control" value="{{ $adminData->username }}" />
                                        ...
                                        <div class="form-group mb-4">
                                            <img id="showImage" src="{{ !empty($adminData->photo) ? url('upload/admin_images/' . $adminData->photo) : url('upload/admin_images/no_image.jpg') }}" style="width: 100px; height: 100px">
                                        </div>
